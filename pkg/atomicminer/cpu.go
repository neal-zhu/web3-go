...
func mine(i int, input types.Input, result chan<- types.Result, reporter *hashrate.HashRateReporter) {
...
func Mine(input types.Input, result chan<- types.Result, reporter *hashrate.HashRateReporter) {
